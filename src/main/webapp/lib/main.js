...
$('#start_publish_button').click(function () {
...
var handleEventStreamMessage = function handleEventStreamMessage(messageJson) {
  ...
  var results = messageJson.Transcript.Results; //&& results[0].Alternatives[0].Items.length > 0
...
$('#stop_publish_button').click(function () {
    closeSocket();
